...
/**
 * Represents the React Native `ViewManager` for the "NitroListView" Nitro HybridView.
 */
public class HybridNitroListViewManager: SimpleViewManager<View>() {
  init {
  ...
  private fun getHybridView(view: View): HybridNitroListView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridNitroListView
  }
}
